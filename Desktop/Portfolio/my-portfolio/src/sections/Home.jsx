...
const socials = [
    {Icon: FaXTwitter, label:"x", href: "https://x.com/pramishthapa17"},
    {Icon: FaLinkedin, label:"LinkedIn", href: "https://www.linkedin.com/in/pramish-thapa-36b828156/"},
    {Icon: FaGithub, label:"GitHub", href: "https://github.com/Pramish17"}
]
    ...
    return(
        ...
        id="home" className="w-full h-screen relative bg-black overflow-hidden">
            <ParticleBackground/>
                ...
                opa;city-30 sm:opacity-20 md:opacity-10
                ...
                <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
                    <div className="w-full lg:pr-24 mx-auto max-w-[48rem">
                        ...
                        bg-linear-to-r from-[#1cd8d2] to via-[#00bf8f] to-[#302b63] drop-shadow-lg"
                        ...
                        >
                           I create reliable digital platforms using microservices, cloud technologies, and modern development practices — enabling organisations to transform ideas into resilient, production-ready systems.
                        </motion.p>
...
<div className="relative hidden lg:block">
    ...
    style={{
        ...
        background: "conic-gradient(from 0deg, #1cd8d2, #00bf8f, #302f8f, #302b63, #1cd8d2)"
    }}
    />
    <motion.img src={avator} alt="Pramish Thapa" 
