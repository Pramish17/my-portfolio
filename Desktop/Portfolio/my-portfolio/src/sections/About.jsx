  ...
  return (
    <section id="about" className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-10 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div
            className="relative w-[160px] h-[160px] md:w-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/25"
            whileHover={{ scale: 1.02 }}
            transition={{ type: "spring", stiffness: 200, damping: 18 }}
          >
            <img src={p} alt="Pramish Thapa profile" className="absolute inset-0 w-full h-full object-cover" />
          </motion.div>
          ...
          <div className="flex flex-1 flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I design and deliver scalable, cloud-native software that drives business growth, improves performance, and supports digital transformation.
            </p>
        ...
        >
          ...
          <p className="text-gray-100 leading-relaxed text-base sm:text-lg">
            I am a software engineer focused on building secure, scalable systems that perform in production. My work spans cloud platforms,
            microservices, and full-stack applications, with hands-on delivery from architecture to deployment.
          </p>
          <p className="mt-4 text-gray-400 text-base sm:text-lg">
            I enjoy working in collaborative teams where strong engineering practices, automation, and clear communication lead to measurable business outcomes.
            Outside work, I like experimenting with coffee recipes and exploring new tools and frameworks.
          </p>
        </motion.div>
      </div>
    </section>
